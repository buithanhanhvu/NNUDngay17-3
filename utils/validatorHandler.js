...
module.exports = {
    ...
    ChangePasswordValidator: [
        ...
        body('newPassword').notEmpty().withMessage("newPassword khong duoc de trong").bail()
            .isStrongPassword(options.password).withMessage(`newPassword dai it nhat ${options.password.minLength} ki tu, trong do it nhat ${options.password.minUppercase} chu hoa, ${options.password.minLowercase} chu thuong, ${options.password.minNumbers} so, ${options.password.minSymbols} ki tu dac biet`)
            .custom((value, { req }) => {
